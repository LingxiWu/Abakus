...
void gerbil::FastReader::readFile(
	...
	if (fastFile.getCompr() == fc_none
		...
		while (filePos < fileSize) {
			...
			// ofstream bubble_fread_run1;
			// bubble_fread_run1.open("bubble_fread_run1.csv", ios::app);
			// bubble_fread_run1 << timer.tv1.tv_sec << "," << timer.tv1.tv_usec << endl; // start time
			// bubble_fread_run1 << timer.tv2.tv_sec << "," << timer.tv2.tv_usec << endl; // end time
			// bubble_fread_run1.close();
